...
> **📌 檔案狀態說明**：01-06 獨立主題檔為**規劃中**，目前以本大綱各節摘要為學習指引。
> 其中 01（產品理解）與 04-06（查詢測試實務）已有現成深度教材，位於
> [projects/prismavision/smart-insight-engine/](../../projects/prismavision/smart-insight-engine/)：
> - 01 產品理解 → [00_overview.md](../../projects/prismavision/smart-insight-engine/00_overview.md)
> - 04 MDFO 查詢理解 → [01_mdof-fundamentals.md](../../projects/prismavision/smart-insight-engine/01_mdof-fundamentals.md)（內容較深，建議挑選需要的章節）
> - 05-06 測試執行與分析 → [03_test-case-design.md](../../projects/prismavision/smart-insight-engine/03_test-case-design.md)
>
> **術語對照**：本大綱的 **MDFO** 與教材檔名的 MDOF 為同一查詢結構，正式拼法以 MDFO 為準。
