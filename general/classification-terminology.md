...
有人會把 facet 說成「一把尺」，但**這個比喻會誤導**：尺暗示有刻度、有大小順序，而 facet 的答案通常沒有——軟膠囊不比膠囊「大」，孕婦不比成人「高」。facet 的每個值只是**不同**，沒有高低。
...
先給背景：我們整套資料系統叫 **LuminNexus**，它由外而內分成三大層——**先把資料抓進來**、**再把資料整理成有結構的知識**、**最後拿來回答問題**。而其中一個負責「回答問題」的系統叫 **TheJournalism**，它自己內部又分成三層——**抽取數字**、**做成報表**、**寫成敘述**。
...
**TheJournalism 整體位在生態系的 Layer 3，而它內部再分 L0 / L1 / L2**——所以同一個東西，講「Layer 3」和講「L0」都對，只是講的層級不同。完整的稱呼約定見 [thejournalism.md](../projects/prismavision/thejournalism.md)。
